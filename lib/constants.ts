import { CustomFiltersTypes } from "../types";
...
// App Id
export const LENSTUBE_APP_ID = "lenster";
export const APP_NAME = "lenster";

// handles
export const LENSTUBE_TWITTER_HANDLE = "echodotxyz";
export const LENSTUBE_GITHUB_HANDLE = "watchereth/echo";
...
export const GIT_DEPLOYED_BRANCH =
